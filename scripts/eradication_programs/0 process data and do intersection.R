...
# 3. Overlap between threatened birds range and rodent eradication programs --------------------------------------------------
## House mouse -----------
...
freq_m_musculus_no_studies <- frequency_df[Rodent_attributed_final=="Mus musculus" & synth_col=="No studies"]
...
#Bird species list
birds_m_musculus_review<- unique(merge_mus_musculus$scientificName) #35 species
...
unique(m_musculus_DIISE_bird_overlap$sci_name) #21 species out of 35 species!

#How many islands?
unique(m_musculus_DIISE_bird_overlap$Island.Name) #44 islands!

#How many eradications?
unique(m_musculus_DIISE_bird_overlap$Eradication.ID) #47 eradications!

#Clean the df
setDT(m_musculus_DIISE_bird_overlap)
m_musculus_DIISE_bird_overlap<- m_musculus_DIISE_bird_overlap[, .(
  sci_name, Eradication.ID, Island.Name,Archipelago, Region, Country, geom
)]
...
m_musculus_DIISE_bird_overlap <- m_musculus_DIISE_bird_overlap[,.(
  scientificName, synth_col, Eradication.ID, Island.Name,Archipelago, Region, Country, geom
)]
...
m_musculus_DIISE_bird_overlap <- m_musculus_DIISE_bird_overlap[order(Island.Name, -as.integer(synth_col))]
...
m_musculus_island<- m_musculus_island[,.(
  Eradication.ID, Island.Name, n_eradications, n_threat_birds, scientificName, synth_col, Rodent_attributed_final, Archipelago , Region, Country, geom
)]
...
freq_r_exulans_no_studies <- frequency_df[Rodent_attributed_final=="Rattus exulans" & synth_col=="No studies"]
...
#Bird species list
birds_r_exulans_review<- unique(merge_r_exulans$scientificName) #118 species
...
unique(r_exulans_DIISE_bird_overlap$sci_name) #33 species out of 118 species!

#How many islands?
unique(r_exulans_DIISE_bird_overlap$Island.Name) #151 islands!

#How many eradications?
unique(r_exulans_DIISE_bird_overlap$Eradication.ID) #164 eradications!
...
r_exulans_DIISE_bird_overlap <- r_exulans_DIISE_bird_overlap[order(Island.Name, -as.integer(synth_col))]
...
freq_r_norvegicus_no_studies <- frequency_df[Rodent_attributed_final=="Rattus norvegicus" & synth_col=="No studies"]
...
#How many eradications?
unique(r_norvegicus_DIISE_bird_overlap$Eradication.ID) #283 eradications!
...
r_norvegicus_DIISE_bird_overlap <- r_norvegicus_DIISE_bird_overlap[order(Island.Name, -as.integer(synth_col))]
...
freq_r_rattus_no_studies <- frequency_df[Rodent_attributed_final=="Rattus rattus" & synth_col=="No studies"]
...
unique(merge_studies_r_rattus$scientificName) #104 species.
...
r_rattus_DIISE_bird_overlap <- r_rattus_DIISE_bird_overlap[order(Island.Name, -as.integer(synth_col))]
...
unique(Rodents_overlap_data$scientificName) #114 species
